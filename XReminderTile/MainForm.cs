...
namespace XReminderTile
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            EnableAutoHideDock = string.Equals(CommonData.IniHelper.Read("XReminderTile", "AutoHide"), "true", StringComparison.OrdinalIgnoreCase);
            EnableOpacityEffect = string.Equals(CommonData.IniHelper.Read("XReminderTile", "OpacityEffect"), "true", StringComparison.OrdinalIgnoreCase);
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                string strTopMost = CommonData.IniHelper.Read("XReminderTile", "TopMost");
                //未配置或配置为true，则置顶
            ...
            try
            {
                string strBackColor = CommonData.IniHelper.Read("XReminderTile", "BackColor");
                int intBackColor;
            ...
            try
            {
                string strStartPosition = CommonData.IniHelper.Read("XReminderTile", "StartPosition");
            ...
            try
            {
                string strSize = CommonData.IniHelper.Read("XReminderTile", "Size");
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (MessageBox.Show(this, "待办事项是否已完成？" + Environment.NewLine + "若选择【是】，会更新待办事项状态为【已完成】。", "待办事项", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Asterisk) != DialogResult.Yes)
                    return;
                XToDoList.ToDoCommon.ToDoDone(reminder.ToDo, this);
            }
        }
