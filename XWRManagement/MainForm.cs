...
namespace XWRManagement
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            BindDict();
            // 随系统启动
            FileInfo fileInfoWeeklyReport = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XWeeklyReport.exe"));
            ...
            checkBoxWeeklyReportAutoStartup.CheckedChanged += checkBoxWeeklyReportAutoStartup_CheckedChanged;
            FileInfo fileInfoTodoList = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XToDoList.exe"));
            ...
            checkBoxTodoListAutoStartup.CheckedChanged += checkBoxTodoListAutoStartup_CheckedChanged;
            FileInfo fileInfoReminderTile = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XReminderTile.exe"));
            ...
            checkBoxReminderTileAutoHide.Checked = CommonData.IniHelper.Read("XReminderTile", "AutoHide").ToLower() == "true" ? true : false;
            checkBoxReminderTileAutoHide.CheckedChanged += checkBoxReminderTileAutoHide_CheckedChanged;
            checkBoxReminderTileOpacityEffect.CheckedChanged -= checkBoxReminderTileOpacityEffect_CheckedChanged;
            checkBoxReminderTileOpacityEffect.Checked = CommonData.IniHelper.Read("XReminderTile", "OpacityEffect").ToLower() == "true" ? true : false;
            checkBoxReminderTileOpacityEffect.CheckedChanged += checkBoxReminderTileOpacityEffect_CheckedChanged;
        }
        ...
        private void BindDict()
        {
            ...
            string tileCommand = CommonData.IniHelper.Read("XReminderTile", "StartupCommandWhenNoItem");
        ...
        {
            FileInfo fileInfo = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XWeeklyReport.exe"));
        ...
        {
            FileInfo fileInfo = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XToDoList.exe"));
        ...
        {
            FileInfo fileInfo = new FileInfo(Path.Combine(CommonData.ApplicationPath, "XReminderTile.exe"));
        ...
        {
            XReminderTile.MainForm reminderTile = new XReminderTile.MainForm();
            reminderTile.IsSetting = true;
            reminderTile.ShowDialog(this);

            CommonData.IniHelper.Write("XReminderTile", "TopMost", reminderTile.SettingTopMost.ToString());
            CommonData.IniHelper.Write("XReminderTile", "BackColor", reminderTile.SettingBackColor.ToArgb().ToString());
            CommonData.IniHelper.Write("XReminderTile", "StartPosition", reminderTile.SettingStartPosition.X.ToString() + "," + reminderTile.SettingStartPosition.Y.ToString());
            //reminderTile.Close();
        ...
        private void radioButtonTileCommand_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButtonTileHide.Checked)
                CommonData.IniHelper.Write("XReminderTile", "StartupCommandWhenNoItem", "Hide");
            else if (radioButtonTileExit.Checked)
                CommonData.IniHelper.Write("XReminderTile", "StartupCommandWhenNoItem", "Exit");
            else
                CommonData.IniHelper.Write("XReminderTile", "StartupCommandWhenNoItem", "NoCommand");
        }
        ...
        {
            CommonData.IniHelper.Write("XReminderTile", "AutoHide", checkBoxReminderTileAutoHide.Checked.ToString());
        }

        private void checkBoxReminderTileOpacityEffect_CheckedChanged(object sender, EventArgs e)
        {
            CommonData.IniHelper.Write("XReminderTile", "OpacityEffect", checkBoxReminderTileOpacityEffect.Checked.ToString());
        }
    }
}
